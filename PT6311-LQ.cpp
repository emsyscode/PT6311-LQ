...
//    Numbers design      
unsigned char number0[]={(0b00100011),(0b01100010),(0b00000000)}; // 0
unsigned char number1[]={(0b00100000),(0b00100000),(0b00000000)}; // 1
unsigned char number2[]={(0b11100001),(0b01000011),(0b00000000)}; // 2
unsigned char number3[]={(0b11100001),(0b01100001),(0b00000000)}; // 3
unsigned char number4[]={(0b11100010),(0b00100001),(0b00000000)}; // 4
unsigned char number5[]={(0b11000011),(0b01100001),(0b00000000)}; // 5
unsigned char number6[]={(0b11000011),(0b01100011),(0b00000000)}; // 6
unsigned char number7[]={(0b00100001),(0b00100000),(0b00000000)}; // 7
unsigned char number8[]={(0b11100011),(0b01100011),(0b00000000)}; // 8
unsigned char number9[]={(0b11100011),(0b00100001),(0b00000000)}; // 9
//    Letters design         
...
unsigned char letterF[]={(0b11000011),(0b00000011),(0b00000000)}; // F
unsigned char letterG[]={(0b00000011),(0b01100011),(0b00000000)}; // G
unsigned char letterH[]={(0b11100010),(0b00100011),(0b00000000)}; // H
unsigned char letterI[]={(0b10001001),(0b01001000),(0b00000000)}; // I
unsigned char letterJ[]={(0b00100001),(0b01100010),(0b00000000)}; // J
unsigned char letterK[]={(0b11010010),(0b00010010),(0b00000000)}; // k
unsigned char letterL[]={(0b00000010),(0b01000010),(0b00000000)}; // L
unsigned char letterM[]={(0b00110110),(0b00100010),(0b00000000)}; // M
unsigned char letterN[]={(0b00100110),(0b00110010),(0b00000000)}; // N
unsigned char letterO[]={(0b00100011),(0b01100010),(0b00000000)}; // O
...
unsigned char letterS[]={(0b11000011),(0b01100001),(0b00000000)}; // S
...
void pt6311_init(void){
  ...
  cmd_with_stb(0b00000000);//  (0b01000000)    cmd1 8 Grids and 20 segments??? (IC da SGNEC ref: S0791 que é igual 6311 pinout)
  delayMicroseconds(1);
...
void led_on(void){
  byte myByte;
    ...
    //diagrams below: 
    myByte =(0b00011101);  // Here is only to invert bit of led 1.
...
void msgHiFolks(){ 
send_char(0x00,(0b11100010),(0b00100011),(0b00000000)); //H
send_char(0x03,(0b10001001),(0b01001000),(0b00000000)); //I
send_char(0x06,(0b00000000),(0b00000000),(0b00000000)); //
send_char(0x09,(0b11000011),(0b00000011),(0b00000000)); //F
send_char(0x0C,(0b00100011),(0b01100010),(0b00000000)); //O
send_char(0x0F,(0b00000010),(0b01000010),(0b00000000)); //L
send_char(0x12,(0b11010010),(0b00010010),(0b00000000)); //K
send_char(0x15,(0b11000011),(0b01100001),(0b00000000)); //S
}
void charactersA(){
clear_VFD();
...
void numbers2(){
clear_VFD();
send_char(0x00,number8[0], number8[1], number8[2]);  
...
delay(2000);
//
led_on(); // This function switch the LED 1 to ON
delay(500);
led_off();
//delay(100);
//
